...
const VIDEO_VISIBLE_TIMEOUT_MS = 60 * SECOND;
const POLL_READYSTATE_TIMEOUT_MS = 40 * SECOND;
const POLL_PLAYING_TIMEOUT_MS = 40 * SECOND;
const PLAYBACK_PROGRESS_CHECK_DELAY_MS = 10 * SECOND;
