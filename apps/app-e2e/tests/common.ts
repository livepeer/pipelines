...
export const VIDEO_VISIBLE_TIMEOUT_MS = 60 * SECOND;
export const POLL_READYSTATE_TIMEOUT_MS = 60 * SECOND;
export const POLL_PLAYING_TIMEOUT_MS = 60 * SECOND;
export const PLAYBACK_PROGRESS_CHECK_DELAY_MS = 10 * SECOND;
export const OVERALL_TEST_TIMEOUT_MS = 120 * SECOND;
