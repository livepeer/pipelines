...
<AccordionGroup>
  <Accordion header="Depth Anything TensorRT" title="Depth Anything TensorRT">
    Refer to [examples/SAM2-Realtime-Example.json](https://github.com/pschroedl/ComfyUI-SAM2-Realtime/blob/main/examples/SAM2-Realtime-Example.json) for a sample workflow
  ...
  <Accordion header="Florence 2" title="Florence 2">
    ...
    Refer to the [README.MD](https://github.com/ad-astra-video/ComfyUI-Florence2-Vision/blob/main/README.md) and [example workflows](https://github.com/ryanontheinside/ComfyUI_RealTimeNodes/tree/main/examples) to learn more
...
<Accordion header="ComfyUI Real-Time Nodes " title="ComfyUI Real-Time Nodes ">
  ...
  Refer to the [README.MD](https://github.com/ryanontheinside/ComfyUI_RealTimeNodes/blob/main/README.MD) and [example workflows](https://github.com/ryanontheinside/ComfyUI_RealTimeNodes/tree/main/examples) to learn more
  ...
  <Accordion header="StreamDiffusion" title="StreamDiffusion">
    This node is useful for styling videos with a diffusion effects. It can be combined with other nodes to create masked effects.

    - **Input:** RGB frame (3, H, W)
    - **Output:** Feature vector (1, 512)

    Refer to the [README.MD](https://github.com/pschroedl/ComfyUI-StreamDiffusion/blob/main/README.md) and [example workflows](https://github.com/pschroedl/ComfyUI-StreamDiffusion/tree/main/examples) to learn more
  ...
  <Tabs>
    ...
    <Tab title="Sample Workflow" header="Sample Workflow">
    ```json
