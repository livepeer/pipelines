...
export function VideoSection() {
  ...
  const transformedIframeUrl = `https://lvpr.tv/?v=${TRANSFORMED_PLAYBACK_ID}&lowLatency=false&muted=true`;
  ...
  return (
    <div className="w-full md:w-[70%] relative md:rounded-lg overflow-hidden bg-black/10 backdrop-blur-sm shadow-lg md:aspect-video h-full md:h-full md:relative">
      ...
      <div className="w-full h-full relative overflow-hidden">
        ...
        <div className="absolute bottom-4 right-4 w-[30%] aspect-video z-30 rounded-lg overflow-hidden border-2 border-white/30 shadow-lg hidden md:block">
          {transformedLoading && (
