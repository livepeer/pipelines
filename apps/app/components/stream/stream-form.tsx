...
const StreamForm = forwardRef(
  ({ stream }: { stream?: any | null }, ref: React.Ref<any>) => {
    ...
    const [inputs, setInputs] = useState<Record<string, any>>(
      selectedPipeline?.config?.inputs || {},
    );
      ...
      <div className="flex flex-col gap-4 mt-5">
          ...
          <>
            ...
            <div className="flex flex-col gap-2 max-w-md">
              ...
              <Input
                ...
                onChange={e =>
                  handleInputChange("output_stream_url", e.target.value)
                }
              />
        ...
        {selectedPipeline.type == "comfyui" ? (
          <div className="flex flex-col gap-2">
            <Label className="text-muted-foreground">ComfyUI Parameters</Label>
            <ComfyUIParamsEditor
