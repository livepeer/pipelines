...
const ComfyUIParamsEditor = ({
  ...
  const [invalidJsonMessage, setInvalidJsonMessage] = useState<string | null>(
    null,
  );
        ...
        <>
          ...
          {invalidJsonMessage && (
            <div className="text-red-500 text-sm">
              You attempted to add invalid character to the JSON. These have
              been reverted. The error was: {invalidJsonMessage}
            </div>
          )}
        </>
      ) : (
