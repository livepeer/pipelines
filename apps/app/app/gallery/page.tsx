...
const communityExperiences = [
  ...
  },
  {
    ...
    prompt:
      "((abstract)) fluid motion ((dynamic)) --creativity 0.8 --quality 3",
  ...
  },
  {
    ...
    prompt:
      "((surreal)) landscape ((digital art)) --creativity 0.75 --quality 3",
    ...
    const fetchExperiences = async () => {
      try {
        ...
        setCommunityExperiences(
          experiences.length > 0 ? experiences : communityExperiences,
        );
      } catch (error) {
          ...
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-4xl font-bold text-gray-900 mb-4">
                Welcome to your launchpad for live AI experiences{" "}
              </h1>
              <p className="text-xl text-gray-600">
                Explore community creations and create your own immersive world
              </p>
            </div>
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-64 p-3 bg-gray-900 text-white text-sm rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
                Create your own Live AI experience with our easy-to-use tools.
                Customize prompts, styles, and more to bring your vision to
                life.
              </div>
            </div>
          </div>
