...
exports.validateEnv = exports.getAppConfig = exports.sendgrid = exports.hubspot = exports.mixpanel = exports.intercom = exports.livepeer = exports.isProduction = exports.config = void 0;
...
const envConfig = {
    ...
    app_secondary: (process.env.NEXT_PUBLIC_WHIP_URL_SECONDARY ||
        ...
        whipUrl: process.env.NEXT_PUBLIC_WHIP_URL_SECONDARY ||
            process.env.NEXT_PUBLIC_WHIP_URL,
        rtmpUrl: process.env.NEXT_PUBLIC_RTMP_URL_SECONDARY ||
            process.env.NEXT_PUBLIC_RTMP_URL,
        newWhipUrl: process.env.NEXT_PUBLIC_AI_GATEWAY_API_BASE_URL_SECONDARY ||
...
exports.livepeer = exports.config.livepeer, exports.intercom = exports.config.intercom, exports.mixpanel = exports.config.mixpanel, exports.hubspot = exports.config.hubspot, exports.sendgrid = exports.config.sendgrid;
const getAppConfig = (searchParams) => {
    const useSecondary = !(0, exports.isProduction)() && searchParams?.get("gateway") === "secondary";
