...
exports.gcpConfig =
  ...
  exports.getGatewayConfig =
  exports.serverConfig =
  exports.ServerEnvironmentConfig =
    void 0;
...
const serverOnlyConfig =
  exports.ServerEnvironmentConfig.parse(serverOnlyEnvConfig);
const serverConfig = async () => serverOnlyConfig;
exports.serverConfig = serverConfig;
const getGatewayConfig = searchParams => {
  const useSecondary =
    !(0, env_1.isProduction)() && searchParams?.get("gateway") === "secondary";
