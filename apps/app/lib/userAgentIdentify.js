...
exports.identifyTikTokInAppBrowser = exports.identifyMobileInAppBrowser = void 0;
const identifyMobileInAppBrowser = (userAgent) => {
    ...
    const isGenericInApp = /Mobile\//i.test(userAgent) &&
...
exports.identifyMobileInAppBrowser = identifyMobileInAppBrowser;
const identifyTikTokInAppBrowser = (userAgent) => {
...
exports.identifyTikTokInAppBrowser = identifyTikTokInAppBrowser;
