...
exports.clipViewsRelations =
  exports.clipsRelations =
  exports.streamsRelations =
  exports.auditLogsRelations =
  exports.purchasesRelations =
  exports.jobsRelations =
  exports.apiKeysRelations =
  exports.pipelinesRelations =
  exports.usersRelations =
  exports.sharedParamsRelations =
    void 0;
const relations_1 = require("drizzle-orm/relations");
const schema_1 = require("./schema");
exports.sharedParamsRelations = (0, relations_1.relations)(
  schema_1.sharedParams,
  ({ one }) => ({
...
exports.pipelinesRelations = (0, relations_1.relations)(
  schema_1.pipelines,
  ({ one, many }) => ({
    sharedParams: many(schema_1.sharedParams),
    user: one(schema_1.users, {
...
exports.apiKeysRelations = (0, relations_1.relations)(
  schema_1.apiKeys,
  ({ one }) => ({
    user: one(schema_1.users, {
...
exports.jobsRelations = (0, relations_1.relations)(
  schema_1.jobs,
  ({ one }) => ({
    user: one(schema_1.users, {
...
exports.purchasesRelations = (0, relations_1.relations)(
  schema_1.purchases,
  ({ one }) => ({
    user: one(schema_1.users, {
...
exports.auditLogsRelations = (0, relations_1.relations)(
  schema_1.auditLogs,
  ({ one }) => ({
    user: one(schema_1.users, {
...
exports.streamsRelations = (0, relations_1.relations)(
  schema_1.streams,
  ({ one }) => ({
    user: one(schema_1.users, {
...
exports.clipsRelations = (0, relations_1.relations)(
  schema_1.clips,
  ({ one, many }) => ({
...
exports.clipViewsRelations = (0, relations_1.relations)(
  schema_1.clipViews,
  ({ one }) => ({
