...
exports.promptQueue = (0, pg_core_1.pgTable)("prompt_queue", {
    ...
    positionIdx: (0, pg_core_1.index)("prompt_queue_position_idx").on(table.position),
    processedIdx: (0, pg_core_1.index)("prompt_queue_processed_idx").on(table.processed),
}));
exports.promptState = (0, pg_core_1.pgTable)("prompt_state", {
    ...
    promptAvatarSeeds: (0, pg_core_1.json)("prompt_avatar_seeds").$type().notNull(),
    userPromptIndices: (0, pg_core_1.json)("user_prompt_indices").$type().notNull(),
    promptSessionIds: (0, pg_core_1.json)("prompt_session_ids").$type().notNull(),
    highlightedSince: (0, pg_core_1.timestamp)("highlighted_since", { withTimezone: true })
        .defaultNow()
        .notNull(),
    isProcessing: (0, pg_core_1.boolean)("is_processing").default(false).notNull(),
