...
exports.upscaleJobs = exports.pgStatMonitor = exports.clipSlugs = exports.clipViews = exports.clips = exports.clipApprovalEnum = exports.clipStatusEnum = exports.streams = exports.auditLogs = exports.purchases = exports.jobs = exports.apiKeys = exports.pipelines = exports.users = exports.sharedParams = exports.validationStatus = void 0;
...
exports.sharedParams = (0, pg_core_1.pgTable)("shared_params", {
...
exports.users = (0, pg_core_1.pgTable)("users", {
    ...
    (0, pg_core_1.check)("users_provider_check", (0, drizzle_orm_1.sql) `(provider)::text = ANY (ARRAY[('discord'::character varying)::text, ('email'::character varying)::text, ('github'::character varying)::text, ('google'::character varying)::text])`),
]);
exports.pipelines = (0, pg_core_1.pgTable)("pipelines", {
    ...
    lastUsed: (0, pg_core_1.timestamp)("last_used", { withTimezone: true, mode: "string" }),
    name: (0, pg_core_1.varchar)(),
...
exports.jobs = (0, pg_core_1.pgTable)("jobs", {
    ...
    creditCost: (0, pg_core_1.numeric)("credit_cost", { precision: 10, scale: 2 }).notNull(),
    ...
    (0, pg_core_1.check)("jobs_status_check", (0, drizzle_orm_1.sql) `(status)::text = ANY ((ARRAY['pending'::character varying, 'in-progress'::character varying, 'completed'::character varying])::text[])`),
]);
exports.purchases = (0, pg_core_1.pgTable)("purchases", {
    purchaseId: (0, pg_core_1.uuid)("purchase_id").defaultRandom().primaryKey().notNull(),
    userId: (0, pg_core_1.text)("user_id"),
    creditsPurchased: (0, pg_core_1.numeric)("credits_purchased", {
        precision: 10,
        scale: 2,
    }).notNull(),
    amountPaid: (0, pg_core_1.numeric)("amount_paid", { precision: 10, scale: 2 }).notNull(),
    createdAt: (0, pg_core_1.timestamp)("created_at", {
        withTimezone: true,
        mode: "string",
    }).defaultNow(),
...
exports.streams = (0, pg_core_1.pgTable)("streams", {
    ...
    (0, pg_core_1.index)("streams_stream_key_idx").using("hash", table.streamKey),
]);
...
exports.clips = (0, pg_core_1.pgTable)("clips", {
    ...
    status: (0, exports.clipStatusEnum)("status").default("uploading").notNull(),
    ...
    approved_at: (0, pg_core_1.timestamp)("approved_at", { withTimezone: true }),
...
exports.clipViews = (0, pg_core_1.pgTable)("clip_views", {
    id: (0, pg_core_1.serial)("id").primaryKey(),
...
exports.clipSlugs = (0, pg_core_1.pgTable)("clip_slugs", {
    slug: (0, pg_core_1.text)("slug").primaryKey(),
    clip_id: (0, pg_core_1.integer)("clip_id")
        .notNull()
        .references(() => exports.clips.id, { onDelete: "cascade", onUpdate: "cascade" }),
    created_at: (0, pg_core_1.timestamp)("created_at", { withTimezone: true }).defaultNow(),
}, table => [
    {
        clipIdUniqueConstraint: (0, pg_core_1.unique)("unq_clip_slugs_clip_id").on(table.clip_id),
    },
]);
exports.pgStatMonitor = (0, pg_core_1.pgView)("pg_stat_monitor", {
    ...
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    sharedBlksDirtied: (0, pg_core_1.bigint)("shared_blks_dirtied", { mode: "number" }),
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    sharedBlksWritten: (0, pg_core_1.bigint)("shared_blks_written", { mode: "number" }),
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    localBlksHit: (0, pg_core_1.bigint)("local_blks_hit", { mode: "number" }),
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    localBlksRead: (0, pg_core_1.bigint)("local_blks_read", { mode: "number" }),
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    localBlksDirtied: (0, pg_core_1.bigint)("local_blks_dirtied", { mode: "number" }),
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    localBlksWritten: (0, pg_core_1.bigint)("local_blks_written", { mode: "number" }),
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    tempBlksRead: (0, pg_core_1.bigint)("temp_blks_read", { mode: "number" }),
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    tempBlksWritten: (0, pg_core_1.bigint)("temp_blks_written", { mode: "number" }),
